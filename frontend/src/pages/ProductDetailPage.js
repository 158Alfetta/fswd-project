            ...
            <div className="col-span-10 md:col-span-4 flex-col justify-between">
                ...
                <div className="m-10 bg-yellow-800 bg-opacity-20 shadow-lg rounded-xl h-3/4 ">
                    ...
                    <div className="pt-3 flex justify-center h-3/4 ">
                        <div className="h-3/4 w-3/4" style={{backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundImage: `url(${product?.image?.[imageIndex] || "https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png"})` }}>
                        </div>
