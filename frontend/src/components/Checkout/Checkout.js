      ...
      <div className="h-screen w-screen">
        ...
        <div className="m-3 mb-10 p-2 bg-blue-200 bg-opacity-30 rounded-xl w-full md:w-8/12 mx-auto grid grid-cols-2">
          <div className="col-span-2">
            <h2 className="text-2xl font-semibold text-center text-gray-600 p-3 mb-3 uppercase">
              Address
            </h2>
          ...
          <div className="mt-3 p-2 rounded-xl shadow-md col-span-2 bg-yellow-100 bg-opacity-70 grid grid-cols-2">
            ...
            <div>
              <div className="m-2">
                ...
                <select
                  class="block p-3 text-gray-600 w-full text-sm mb-2"
          ...
          <div className="mt-5 text-center col-span-2 flex justify-end">
            <div className="py-1 px-4 font-extrabold">
              Total: {(summary + shippingCost).toLocaleString()} THB <br />{" "}
          ...
          <div className="py-4">
            <a
              href="/cart"
              class="ml-5 flex font-semibold text-indigo-600 text-sm my-auto "
            >
              <svg
                class="fill-current mr-2 mt-0.5 text-indigo-600 w-4"
                viewBox="0 0 448 512"
              >
